...
public class AnalyzeTest {
    ...
    @Test
    public void whenListOfPupilAverageDiffScope() {
        List<Tuple> average = Analyze.averageScoreBySubject(
                List.of(
                        new Pupil("Ivanov",
                                List.of(new Subject("Math", 100),
    ...
    @Test
    public void whenBestPupilPetrov() {
        Tuple best = Analyze.bestStudent(
                List.of(
                        new Pupil("Ivanov",
                                List.of(new Subject("Math", 10),
                                        new Subject("Lang", 100))),
                        new Pupil("Petrov",
                                List.of(new Subject("Math", 100),
                                        new Subject("Lang", 100)))
        ...
        assertThat(best, is(new Tuple("Petrov", 200D)));
    }
